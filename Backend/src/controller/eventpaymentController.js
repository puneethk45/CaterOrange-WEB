...
const event_payment = async (req, res) => {
  const { paymentType, merchantTransactionId, phonePeReferenceId, paymentFrom, instrument, bankReferenceNo, amount, customer_generated_id, eventorder_id } = req.body;
  console.log(paymentType, merchantTransactionId, phonePeReferenceId, paymentFrom, instrument, bankReferenceNo, amount, customer_generated_id, eventorder_id)
...
console.log("hello after updation")
